...
const Blogs = () => {
    return (
        <div className='bg-yellow-400'>
            <h1 className='text-center font-bold text-5xl p-5'>All Qustion </h1>
            <div tabIndex={1} className="collapse bg-yellow-200 collapse-plus border border-base-300 bg-base-100 rounded-box">
            ...
            <div tabIndex={2} className="collapse bg-yellow-200 collapse-plus border border-base-300 bg-base-100 rounded-box">
                <div className="collapse-title text-xl font-medium">
            ...
            <div tabIndex={3} className="collapse bg-yellow-200 collapse-plus border border-base-300 bg-base-100 rounded-box">
                <div className="collapse-title text-xl font-medium">
            ...
            <div tabIndex={4} className="collapse bg-yellow-200 collapse-plus border border-base-300 bg-base-100 rounded-box">
                <div className="collapse-title text-xl font-medium">
